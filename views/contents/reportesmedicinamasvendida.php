...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Reporte de Productos mas Vendidos </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Reportes</a></li>
                    <li class="breadcrumb-item active">Productos mas Vendidos</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card card-danger shadow">
                    <div class="card-body">
                        <div class="row mb-3 d-flex justify-content-center">
                            ...
                            <div class="col-6 col-md-4 col-lg-3 form-group ">
                                <button class="btn btn-dark btn-sm " id="btn-consulta-v" style="margin-top: 35px;">
                        ...
                        <div id="tabla-reporte-v" class="row bg-white d-none">
                            <div class="col-12 mt-2">
                                <div class="row">
                                    <div class="col-6 col-md-8 col-lg-9" style="padding-left: 125px; margin-top: 65px;">
                                        ...
                                        <h6 class="text-danger">Desde:
                                            <span class="text-dark" id="fecha-inicio-r-v2"></span> - Hasta:
                                            <span class="text-dark" id="fecha-fin-r-v2"></span>
                                        </h6>
                                    </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body table-responsive p-0">
                                                    <table class="table table-hover text-nowrap">
                                                        ...
                                                        <tbody id="body-reporte-servicio-v">
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <th></th>
                                                            <th></th>
                                                            <th id="totales-v" class="text-danger"></th>
                                                            <th id="total-general-v" class="text-danger"></th>
                                ...
                                <div class="col-12 col-md-8">
                                    <h3 class="card-title"><b>Cantidad mas Vendida</b></h3>
...
<script src="<?=BASE?>views/dist/js/scripts/reportesMedicinamasVendida.js?ver=1.1.1.2"></script>